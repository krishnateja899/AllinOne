...
/**
 * How to access:
 * 1.) Declare the variable:      private InternetConnectionChecker internetChecker;
 * 2.) Initialize the variable:   internetChecker = new InternetConnectionChecker(this);
 * 3.) Check the internet:          internetChecker.checkInternetConnection() || internetChecker.failureAlert(); ||   internetChecker.serverErrorAlert();
 */
