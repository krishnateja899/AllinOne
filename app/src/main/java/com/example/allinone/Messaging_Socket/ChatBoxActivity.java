...
public class ChatBoxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Nickname= (String)getIntent().getExtras().getString(MessagingActivity.NICKNAME);
        //connect you socket client to the server
        try {
            socket = IO.socket("http://10.0.2.2:3000");//add the url here, the present one is local url.
            socket.connect();
